...
$query = "SELECT * FROM myorders WHERE user_id=$current_user";
    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6"><h2>My Orders</h2></div>
...
echo ' <tbody> <tr align="center">';
                       ...
                       echo  '<td><span class="label label-success">'.$row['order_date'] .'</span></td>'; 
					   $i++;
...
echo'<h1 class="NoOrder">No order yet !</h1>';	
...
?>
 ...
 <form action="more_det.php" method="post" style="margin-left: 500px;"><!--if users click on the send button then display the FeedBackMessage page -->
     
          
            <label for="name"><h3><b>To more details, enter order code : &nbsp;</h3></b></label><!--new column,the column contains the label name-->
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="text" name="orderCode" class="order_code_input">	&nbsp;&nbsp;
			<input type="submit" name="click"  class="button4" value="click">	
